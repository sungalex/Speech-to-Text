...
if [ $stage -le 8 ]; then
  ...
  (
    ...
    for test in test_clean test_other dev_clean dev_other; do
      steps/decode.sh --nj 8 --cmd "$decode_cmd" exp/mono/graph_nosp_tgsmall \
...
if [ $stage -le 9 ]; then
  ...
  (
    ...
    for test in test_clean test_other dev_clean dev_other; do
      steps/decode.sh --nj 8 --cmd "$decode_cmd" exp/tri1/graph_nosp_tgsmall \
...
if [ $stage -le 10 ]; then
  ...
  (
    ...
    for test in test_clean test_other dev_clean dev_other; do
      steps/decode.sh --nj 8 --cmd "$decode_cmd" exp/tri2b/graph_nosp_tgsmall \
...
if [ $stage -le 12 ]; then
  ...
  (
    ...
    for test in test_clean test_other dev_clean dev_other; do
      ...
      steps/lmrescore_const_arpa.sh \
        --cmd "$decode_cmd" data/lang_nosp_test_{tgsmall} \
        data/$test exp/tri4b/decode_nosp_{tgsmall}_$test
    done
  )&
fi
...
if [ $stage -le 13 ]; then
  ...
  (
    ...
    for test in test_clean test_other dev_clean dev_other; do
      ...
      steps/lmrescore_const_arpa.sh \
        --cmd "$decode_cmd" data/lang_test_{tgsmall} \
        data/$test exp/tri4b/decode_{tgsmall}_$test
    done
  )&
fi
